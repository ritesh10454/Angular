...
@Component({
  selector: 'app-jraccess-right',
  templateUrl: './jraccess-right.component.html',
  styleUrls: ['./jraccess-right.component.css']
})
export class JRAccessRightComponent implements OnInit {
  empcd:string="";
  headingMenu:string="";
  mainMenu:string="";
  currMenu:string="";
  ...
  isUser:any;
  objAccesrights:any;
  objChk ="../../../../assets/Images/Chk.png";
  objCross="../../../../assets/Images/Cross.png";
  ...
  getJRAccessrights()
  {
    this.httpService.getJRAccessrights().subscribe(res=>{
      if(res.response==-1)
      {
        this.errorMsg=res.responseMsg;
      ...
      this.objAccesrights=res.responseObjectList;
      this.objAccesrights.forEach((itm:any) => {
       itm.isAdmin=(itm.isAdmin==true)? this.objChk:this.objCross
        itm.isHR= (itm.isHR==true)? this.objChk:this.objCross
        itm.isFinalAuth= (itm.isFinalAuth==true)? this.objChk:this.objCross
        itm.isFirstAuth= (itm.isFirstAuth==true)? this.objChk:this.objCross;
        itm.isUser= (itm.isUser==true)? this.objChk:this.objCross;
      });
    });
